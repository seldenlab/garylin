...
### Modeling archaeological epistemology for Gary dart point type-varieties
...
ggplot(data, aes(x=maxl, fill = Site)) +
...
ggplot(data, aes(x=maxw, fill = Site)) +
  geom_density(alpha = .4) +
  scale_color_brewer(palette = "Set1") +
  xlim(0,75)
...
ggplot(data, aes(x=maxth, fill = Site)) +
  geom_density(alpha = .4) +
  scale_color_brewer(palette = "Set1") +
  xlim(0,25)
...
ggplot(data, aes(x=maxstl, fill = Site)) +
  geom_density(alpha = .4) +
  scale_color_brewer(palette = "Set1") +
  xlim(0,35)
...
ggplot(data, aes(x=maxstw, fill = Site)) +
  geom_density(alpha = .4) +
  scale_color_brewer(palette = "Set1") +
  xlim(0,40)
...
```{r setwd ld define variables 4, echo=TRUE}
# set working directory
setwd(getwd())
# load data
data<-read.csv("garymorphlm.csv",header = TRUE, as.is=TRUE)
...
lcheck3 <- pvptmx$maxl >= 33 & pvptmx$maxl < 46

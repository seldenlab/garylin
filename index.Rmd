...
This volume enlists a variety of tools from the [Open Review Toolkit](https://www.openreviewtoolkit.org/), and some of the code provided for bookdown, and follows the excellent example advanced by [Ben Marwick](https://benmarwick.github.io/bookdown-ort/). I extend my gratitude to all who contribute comments and constructive criticisms throughout the development and maturation of this project.
